...
* [`src/auth/styles.cljs`](src/auth/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/auth/`](src/auth/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/auth/core.cljs): contains the SPA entry point, `init`
* [`test/auth/`](test/auth/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `auth` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/auth/config.cljs) defaults to `true` in
